...
params:
  ...
  chip: test-chip
  samples: ../tests/output/01_pre_imputation/single/29sep20_GSA_PLINK.qc.samples ../tests/output/01_pre_imputation/single/31aug20_GSA_PLINK.qc.samples
  snps: ../tests/output/01_pre_imputation/single/29sep20_GSA_PLINK.qc.snps ../tests/output/01_pre_imputation/single/31aug20_GSA_PLINK.qc.snps
  snps_final: ../tests/output/01_pre_imputation/test-gwas.qc.snps
  samples_merged: ../tests/output/01_pre_imputation/test-gwas.merged.statistics
  samples_final: ../tests/output/01_pre_imputation/test-gwas.qc.samples
  samples_excluded: ../tests/output/01_pre_imputation/test-gwas.qc.samples.excluded
  snps_excluded: ../tests/output/01_pre_imputation/test-gwas.qc.snps.excluded
  filter_statistics: ../tests/output/01_pre_imputation/single/29sep20_GSA_PLINK.statistics ../tests/output/01_pre_imputation/single/31aug20_GSA_PLINK.statistics
---
