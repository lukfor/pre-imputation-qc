...
datatable(out %>% select("IID1","IID2","PI_HAT"), options = list(order = list(list(3, 'desc'))))
...
kin = read.table(params$kin_filename, h=T)
...
datatable(out %>% select("ID1","ID2","KINSHIP"), options = list(order = list(list(3, 'desc'))))
