...
params:
  ...
  study_outliers: ../tests/output/03_post_imputation/test-gwas-test.outliers.txt
  reference_cluster: ../tests/output/03_post_imputation/test-gwas-test.clusters.txt
